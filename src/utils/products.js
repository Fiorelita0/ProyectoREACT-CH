const products =[
    {
        id:1,
        title: "Alimento Pedigree para Cachorro Etapa 1 Sano Crecimiento 2 A 18 MESES",
        marca: "Pedigree",
    ...
    {
        id:2,
        title: "Alimento Pedigree para Perro Adulto Etapa 2 Sabor Carne y Vegetales 1 A 7 AÑOS",
        marca: "Pedigree",
    ...
    {
        id:3,
        title: "Alimento Pedigree para Perro Adulto Etapa 2 Carne Pollo y Cereales 1 A 7 AÑOS",
        marca: "Pedigree",
    ...
    {
        id:4,
        title: "Alimento Pedigree para Perro Adulto Razas Pequeñas Etapa 2 Sabor Carne Pollo y Cereales 1 A 7 AÑOS",
        marca: "Pedigree",
    ...
    {
        id:5,
        title: "Alimento Pedigree para Perro Adulto Etapa 2 Balance Natural 1 A 7 AÑOS",
        marca: "Pedigree",
        imagen: "https://http2.mlstatic.com/D_NQ_NP_705094-MLM31231109831_062019-O.jpg",
        descripcion: "Pedigree® Adulto Etapa 2 Balance Natural es alimento completo y balanceado. Elaborado con carne, pollo, trigo, maíz, zanahoria y espinaca sin saborizantes artificiales. Cubre las 4 necesidades universales: SISTEMA INMUNE FUERTE gracias a antioxidantes, como la vitamina E, que contribuye a mantener sus defensas saludables. SALUD ORAL ÓPTIMA con cada croqueta, pues ayudan a la limpieza de sus dientes, a reducir la formación del sarro y a que sus encías estén más saludables. SISTEMA DIGESTIVO SALUDABLE a razón de un balance óptimo de fibra y proteínas de alta calidad que contribuyen a un sistema digestivo saludable y heces más firmes PIEL Y PELO ESPECTACULARES, gracias al aceites escenciales como el Omega 6 y a minerales como el Zinc, que nutren y fortalecen su piel, protegiéndolo más efectivamente de agresiones externas, y logrando que su pelo esté más brilloso",
        precio: 800,
        peso: "4kg",
        stock: 80,
        categoria: "secos",
    ...
    {
        id:6,
        title: "Alimento Pedigree para Perro Adulto Mayor Etapa 3 +7 AÑOS",
        marca: "Pedigree",
